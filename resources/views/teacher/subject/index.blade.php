...
<!-- /Header -->
    ...
    <div class="breadcrumb-bar">
        ...
        <a
            href="{{route("addSubject")}}"
            class="border-0 blue-btn-radius"
            style="float:right; margin-right: 10vh; text-decoration: none; color: white"
        >
            <span class="fa fa-plus mr-2"></span>
            Add Subject
        </a>
        ...
        <a
            href="/teacher"
            class="border-0 blue-btn-radius"
            style="float:right; margin-right: 20vh; text-decoration: none; color: white"
        >
