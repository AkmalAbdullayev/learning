...
@section("list")
    <div class="col-md-12">
        <h4 class="text-center mb-4 font-weight-bold" style="font-family: cursive">Список Предметов</h4>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-center mb-0">
                        ...
                        <tr class="text-center">
                            <th class="font-weight-bold" style="font-family: cursive">Название</th>
                            <th class="font-weight-bold" style="font-family: cursive">Chapters</th>
                            <th class="font-weight-bold" style="font-family: cursive">Topics</th>
                            <th class="font-weight-bold" style="font-family: cursive">Тесты</th>
                            <th class="font-weight-bold" style="font-family: cursive">Действие</th>
                        </tr>
                        </thead>
                        <tbody>
                        @forelse($teacher_subjects as $subject)
                            <form action="{{route("deleteSubject", $subject->id)}}" method="post">
                                <tr class="d-flex justify-content-around align-content-around">
                                    <td class="text-center">
                                        <h2 class="table-avatar">
                                            ...
                                            <span style="font-size: 20px">{{$subject->subject->name}}</span>
                                        </h2>
                                    </td>
                                    <td>
                                        <a>{{$chapters}}</a>
