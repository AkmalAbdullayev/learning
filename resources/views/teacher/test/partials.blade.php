...
@section("list")
    <div class="col-md-12">
        <h4 class="text-center mb-4 font-weight-bold" style="font-family: cursive">Список Тестов</h4>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-center mb-0">
                        ...
                        <tr class="d-flex justify-content-around">
                            <th class="font-weight-bold text-center" style="font-family: cursive">Тесты</th>
                            <th class="font-weight-bold text-center" style="font-family: cursive">Создано</th>
                            <th class="font-weight-bold text-center" style="font-family: cursive">Действие</th>
                        </tr>
                        </thead>
                        <tbody>
