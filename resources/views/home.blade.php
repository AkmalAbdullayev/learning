                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-center mb-0">
                            ...
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{asset('admin/assets/img/profiles/avatar-07.jpg')}}" alt="User Image"></a>
                            ...
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{asset('admin/assets/img/profiles/avatar-17.jpg')}}" alt="User Image"></a>
                            ...
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{asset('admin/assets/img/profiles/avatar-06.jpg')}}" alt="User Image"></a>
